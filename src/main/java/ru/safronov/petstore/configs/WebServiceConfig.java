...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean messageDispatcherServlet(ApplicationContext applicationContext) {
        ...
        servletSOAP.setApplicationContext(applicationContext);
        servletSOAP.setTransformWsdlLocations(true);
        return new ServletRegistrationBean(servletSOAP, "/ws/*");
    }
    ...
    public DefaultWsdl11Definition productsWsdl11Definition(XsdSchema productsSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.safronov.com/spring/ws/products");
